...
# simple test square-grid 100x100 positions
# 1000 known positions
# 50000 known edges with some noise
# try to establish 9000 missing positions...
...
for i in range(50000):
    while True:
        xy = [random.randint(0, 99) for i in range(4)]
